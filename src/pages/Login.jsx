...
import { Presentation, Mail, Lock, Loader2, User, Eye, EyeOff, Check, Moon, Sun } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-indigo-50 to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 px-4 py-12 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight animate-fade-in" style={{ animationDelay: '100ms' }}>Welcome back</h2>
          <p className="mt-2 text-slate-600 dark:text-slate-300 animate-fade-in" style={{ animationDelay: '200ms' }}>Enter your credentials to access your account</p>
        </div>
        ...
        <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm p-8 rounded-3xl shadow-2xl shadow-slate-200/50 dark:shadow-slate-900/50 border border-slate-100 dark:border-slate-700 animate-slide-in" style={{ animationDelay: '300ms' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <a href="#" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 font-medium">Forgot password?</a>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-700 text-center text-slate-600 dark:text-slate-300">
            ...
            <Link to="/register" className="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 font-bold hover:underline underline-offset-4">
              Create one for free
            </Link>
          </div>
        </div>
